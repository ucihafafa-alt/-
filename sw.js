const CACHE='tengerin-melmii-v10-pdf-word-final-20260629';
self.addEventListener('install', e => { self.skipWaiting(); e.waitUntil(caches.open(CACHE).then(c => c.addAll(['./','index.html','app.js?v=v10_pdf_word_final_20260629','icon.png','bg.jpg','manifest.json']))); });
